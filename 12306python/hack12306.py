...
class HackTickets(object):
    ...
    def login(self):
        ...
        # 自动填充用户名
        J_user_name = self.driver.find_by_id('J-userName')
        J_user_name.fill(self.username)
        # self.driver.fill('J-userName', self.username)
        # 自动填充密码
        J_password = self.driver.find_by_id('J-password')
        J_password.fill(self.passwd)
    ...
    def searchMore(self):
        ...
        # 选择车次席别
        self.driver.find_by_text(self.seat_type).click()
